...
const Certificates = () => {
  return (
    <section className="bg-ink-950 pt-20 pb-28 px-6 md:px-12 w-full relative overflow-hidden font-sans">

      {/* Torn paper divider at top (transition from dark Education section) */}
      ...
      <div className="absolute top-16 left-6 md:left-16 text-brand-500 opacity-20 animate-pulse">
      ...
      <div className="absolute bottom-20 right-8 md:right-24 text-brand-500 opacity-20 animate-pulse" style={{ animationDelay: '1.5s' }}>
