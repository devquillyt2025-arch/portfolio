...
import heroVideo from '../assets/hero video/jeevith-hero.mp4';
    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="hidden lg:flex flex-col gap-6 fixed left-6 top-1/2 -translate-y-1/2 z-50">
        <a
          ...
          className="text-white drop-shadow-[0_2px_5px_rgba(0,0,0,0.85)] hover:scale-125 transition-transform duration-300"
          aria-label="GitHub"
        >
      ...
      {/* Content Container */}
      <div className="absolute inset-0 z-20 px-6 pb-10 md:pb-[5%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            <a href={socialLinks.github} target="_blank" rel="noopener noreferrer" className="text-white drop-shadow-[0_2px_5px_rgba(0,0,0,0.85)]" aria-label="GitHub">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M12 2C6.477 2 2 6.484 2 12.017c0 4.425 2.865 8.18 6.839 9.504.5.092.682-.217.682-.483 0-.237-.008-.868-.013-1.703-2.782.605-3.369-1.343-3.369-1.343-.454-1.158-1.11-1.466-1.11-1.466-.908-.62.069-.608.069-.608 1.003.07 1.531 1.032 1.531 1.032.892 1.53 2.341 1.088 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.113-4.555-4.951 0-1.093.39-1.988 1.029-2.688-.103-.253-.446-1.272.098-2.65 0 0 .84-.27 2.75 1.026A9.564 9.564 0 0112 6.844c.85.004 1.705.115 2.504.337 1.909-1.296 2.747-1.027 2.747-1.027.546 1.379.202 2.398.1 2.651.64.7 1.028 1.595 1.028 2.688 0 3.848-2.339 4.695-4.566 4.943.359.309.678.92.678 1.855 0 1.338-.012 2.419-.012 2.747 0 .268.18.58.688.482A10.019 10.019 0 0022 12.017C22 6.484 17.522 2 12 2z" clipRule="evenodd" /></svg>
            </a>
            <a href={socialLinks.linkedin} target="_blank" rel="noopener noreferrer" className="text-white drop-shadow-[0_2px_5px_rgba(0,0,0,0.85)]" aria-label="LinkedIn">
          ...
          >
            <span className="text-white [text-shadow:0_2px_4px_rgba(0,0,0,0.95),0_6px_20px_rgba(0,0,0,0.85),0_1px_2px_rgba(0,0,0,1)]">
              {heroContent.greeting},
            </span>
            <br />
            <span className="text-white [-webkit-text-stroke:2px_black] [paint-order:stroke_fill] [text-shadow:0_4px_14px_rgba(0,0,0,0.6)]">
          ...
          <p
            data-aos="fade-up"
            data-aos-delay="200"
            className="text-white text-xs md:text-base font-semibold mb-6 max-w-md [text-shadow:0_1px_3px_rgba(0,0,0,0.95),0_2px_10px_rgba(0,0,0,0.8)]"
          >
