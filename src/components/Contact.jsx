...
const Contact = () => {
  ...
  return (
    <section ref={ref} id="contact" className="bg-ink-950 w-full min-h-screen relative overflow-hidden flex items-end pt-32 pb-0 md:pb-0 border-t border-ink-800">
      ...
      <div className="relative z-10 w-full flex justify-end items-end">
        <div 
          data-aos="fade-up"
          className="bg-ink-900 border border-brand-500/15 w-full md:w-[85%] lg:w-[75%] p-8 md:p-16 text-white flex flex-col justify-between"
        >
          <div className="flex flex-col sm:flex-row justify-between items-start gap-8 mb-12">
            ...
            <a
              ...
              className="flex items-center gap-2 text-xs font-black uppercase tracking-wider bg-white/10 hover:bg-white hover:text-brand-600 border border-white/20 px-4 py-2 rounded-full transition-all duration-300"
            >
